...
export default function Home() {
  ...
  return (
    <>
      ...
      <main
        id="home"
        className="min-h-screen bg-black text-green-500 px-4 py-10 font-mono overflow-x-hidden"
      >
        <Header />
        {/* Hero Section */}
        <section className="min-h-screen flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <div className="w-48 h-48 animate-bounce md:w-64 md:h-64 mx-auto rounded-full overflow-hidden border-4 border-green-400 shadow-[0_0_20px_4px_#22c55e] mb-6">
              <Image
        ...
        <section id="about" className="py-20 max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-green-200">
              I&apos;m a web &amp; app developer with a passion for building
              clean and interactive UIs. I specialize in React, Next.js, and
              Firebase. Currently working at Invention and Innovation.
            </p>
          </motion.div>
        </section>
        ...
        <section
          id="projects"
          className="py-20 bg-black bg-opacity-60 backdrop-blur-lg"
        >
